      ...
      <div class="sidebar">
        <div class="searchform">
          <form id="formsearch" name="formsearch" method="get" action="/search.php">
            <span>
            <input name="search" class="editbox_search" id="editbox_search" maxlength="80" placeholder="Поиск по сайту:" type="text" />
            </span>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="/?<?=setPagePar('category', $category['id']);?>"><?=$category['title'];?></a></li>
            <?endforeach;?>
          </ul>
        </div>
      </div>
